 ...
 */class nt extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let o=i._$litPart$;if(void 0===o){const t=s?.renderBefore??null;i._$litPart$=o=new X(e.insertBefore(N(),t),t,void 0,s??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const at=rt.litElementPolyfillSupport;at?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.2");const lt={node_cpu:"cpu",node_memory_percentage:"memory_pct",node_memory:"memory_gb",node_disk:"disk_gb",node_max_disk:"disk_max_gb",node_uptime:"uptime_h"},ct={container_cpu:"cpu",container_memory_percentage:"memory_pct",container_memory:"memory_gb",container_disk:"disk_gb",container_max_disk:"disk_max_gb",container_uptime:"uptime_h",container_netin:"net_in_mbs",container_netout:"net_out_mbs",status:"running"},dt={storage_used:"used_gb",storage_total:"total_gb",storage_used_percentage:"used_pct"},ht={Node:"node",Container:"lxc",QEMU:"vm",Storage:"storage"};function pt(t){return"node"===t?lt:"storage"===t?dt:ct}function mt(t){return null==t?"—":parseFloat(t).toFixed(1)+"%"}function ut(t){if(null==t)return"—";const e=parseFloat(t);return isNaN(e)?"—":e>=1?e.toFixed(1)+" GiB":(1024*e).toFixed(0)+" MiB"}function _t(t){if(null==t)return"—";const e=parseFloat(t);return isNaN(e)?"—":e>=1?e.toFixed(1)+" MB/s":e>=.001?(1024*e).toFixed(1)+" KB/s":(1024*e*1024).toFixed(0)+" B/s"}class ft extends nt{static properties={label:{type:String},value:{type:String},percent:{type:Number}};static styles=r`
  ...
  `;_colorClass(){const t=this.percent??0;return t>=90?"error":t>=70?"warning":"success"}render(){const t=Math.min(100,Math.max(0,this.percent??0));return F`
    ...
    `}}customElements.define("proxmox-stat-bar",ft);class gt extends nt{static properties={group:{type:Object},mode:{type:String}};static styles=r`
    :host {
      display: block;
    }
    .header {
  ...
  `;_s(t){return this.group?.entities?.[t]?.state?.state??null}render(){const{mode:t,group:e}=this,s=this._s("cpu"),i=this._s("memory_pct"),o=this._s("disk_gb"),r=this._s("disk_max_gb"),n=this._s("uptime_h"),a=parseFloat(s)||0,l=parseFloat(i)||0,c=o&&r?parseFloat(o)/parseFloat(r)*100:0;return F`
      ...
      ${"minimal"!==t?F`
            ...
            ></proxmox-stat-bar>
          `:""}
    `}}customElements.define("proxmox-node-row",gt);class $t extends nt{static properties={group:{type:Object},mode:{type:String}};static styles=r`
    :host {
      display: flex;
      align-items: center;
      gap: 6px;
  ...
  `;_s(t){return this.group?.entities?.[t]?.state?.state??null}render(){const{mode:t,group:e}=this,s=this._s("running"),i=this._s("cpu"),o=this._s("memory_pct"),r=this._s("disk_gb");this._s("disk_max_gb");const n="on"===s,a="vm"===e?.type?"VM":"CT",l="minimal"===t;return F`
      ...
      ${l?"":F`
          ...
          `}
    `}}customElements.define("proxmox-vm-row",$t);class vt extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};static styles=r`
    .editor {
      display: flex;
  ...
  `;setConfig(t){this._config={title:"Proxmox",mode:"normal",...t}}_changed(t,e){this._config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,[t]:e}},bubbles:!0,composed:!0}))}render(){return this._config?F`
      <div class="editor">
        <ha-textfield
          label="Title"
    ...
    `:F``}}customElements.define("proxmox-card-editor",vt);const xt=["minimal","normal","dense"];class yt extends nt{static properties={hass:{attribute:!1},_config:{state:!0},_mode:{state:!0}};static styles=r`
    :host {
      display: block;
    }
    .card-content {
      ...
      ${t.map((t,o)=>{const r=e.filter(e=>e.node_device_id===t.device_id),n=s.filter(e=>e.node_device_id===t.device_id);return F`
          ...
          <div class="node-block">
            ...
            ${r.length>0?F`
                  ...
                  ${this._renderNetworkSection(r,i)}
                `:""}
            ${n.length>0?this._renderStorageSection(n,i):""}
          </div>
        `})}
      ${o.length>0?F`
            <hr class="node-divider">
            ${this._renderVmSection(o,i)}
            ${this._renderNetworkSection(o,i)}
          `:""}
      ${s.filter(e=>!t.find(t=>t.device_id===e.node_device_id)).length>0?this._renderStorageSection(s.filter(e=>!t.find(t=>t.device_id===e.node_device_id)),i):""}
