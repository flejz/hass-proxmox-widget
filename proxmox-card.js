 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class nt extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let o=i._$litPart$;if(void 0===o){const t=s?.renderBefore??null;i._$litPart$=o=new X(e.insertBefore(U(),t),t,void 0,s??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return I}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const at=rt.litElementPolyfillSupport;at?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.2");const lt={node_cpu:"cpu",node_memory_percentage:"memory_pct",node_memory:"memory_gb",node_disk:"disk_gb",node_max_disk:"disk_max_gb",node_uptime:"uptime_h"},ct={container_cpu:"cpu",container_memory_percentage:"memory_pct",container_memory:"memory_gb",container_disk:"disk_gb",container_max_disk:"disk_max_gb",container_uptime:"uptime_h",container_netin:"net_in_mbs",container_netout:"net_out_mbs",status:"running"},dt={Node:"node",Container:"lxc",QEMU:"vm"};function ht(t){return"node"===t?lt:ct}class pt extends nt{static properties={label:{type:String},value:{type:String},percent:{type:Number}};static styles=r`
    :host {
      display: flex;
      align-items: center;
      gap: 6px;
  ...
  `;setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={title:"Proxmox",mode:"normal",exclude:[],...t},ft.includes(this._config.mode)||(this._config.mode="normal"),this._mode=null}get _activeMode(){return this._mode??this._config?.mode??"normal"}_switchMode(t){this._mode=t}render(){if(!this.hass||!this._config)return B``;const{nodes:t,vms:e}=function(t,e){if(!t?.entities)return{nodes:[],vms:[]};const s=new Set(e?.exclude??[]),i=new Map;for(const[e,o]of Object.entries(t.entities))"proxmoxve"===o.platform&&(s.has(e)||o.device_id&&(i.has(o.device_id)||i.set(o.device_id,[]),i.get(o.device_id).push({entity_id:e,translation_key:o.translation_key})));const o=[],r=[];for(const[e,s]of i){const i=t.devices?.[e],n=dt[i?.model];if(!n)continue;const a=i?.name_by_user||i?.name||e,l=ht(n),c={};for(const{entity_id:e,translation_key:i}of s){const s=l[i];if(!s||s in c)continue;const o=t.states?.[e]??null;c[s]={entity_id:e,state:o}}const d={type:n,name:a,device_id:e,node_device_id:i?.via_device_id,entities:c};"node"===n?o.push(d):r.push(d)}return o.sort((t,e)=>t.name.localeCompare(e.name)),r.sort((t,e)=>t.name.localeCompare(e.name)),{nodes:o,vms:r}}(this.hass,this._config),s=this._activeMode;return B`
      <ha-card>
        <div class="card-content">
          ...
          ${0===t.length&&0===e.length?B`<div class="empty">No Proxmox entities found.<br>Configure the Proxmox VE integration in Home Assistant.</div>`:this._renderNodes(t,e,s)}
        </div>
      </ha-card>
    ...
    `}_renderNodes(t,e,s){const i=e.filter(e=>!t.find(t=>t.device_id===e.node_device_id));return 0===t.length?B`${this._renderVmList(e,s)}`:B`
      ${t.map((t,i)=>{const o=e.filter(e=>e.node_device_id===t.device_id);return B`
          ${i>0?B`<hr class="node-divider">`:""}
          <div class="node-block">
            <proxmox-node-row .group=${t} .mode=${s}></proxmox-node-row>
            ${o.length>0&&"minimal"!==s?B`
