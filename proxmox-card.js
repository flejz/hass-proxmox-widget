 ...
 */class nt extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let o=i._$litPart$;if(void 0===o){const t=s?.renderBefore??null;i._$litPart$=o=new X(e.insertBefore(N(),t),t,void 0,s??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const at=rt.litElementPolyfillSupport;at?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.2");const lt={node_cpu:"cpu",node_memory_percentage:"memory_pct",node_memory:"memory_gb",node_disk:"disk_gb",node_max_disk:"disk_max_gb",node_uptime:"uptime_h"},ct={container_cpu:"cpu",container_memory_percentage:"memory_pct",container_memory:"memory_gb",container_disk:"disk_gb",container_max_disk:"disk_max_gb",container_uptime:"uptime_h",container_netin:"net_in_mbs",container_netout:"net_out_mbs",status:"running"},dt={storage_used:"used_gb",storage_total:"total_gb",storage_used_percentage:"used_pct"},ht={Node:"node",Container:"lxc",QEMU:"vm",Storage:"storage"};function pt(t){return"node"===t?lt:"storage"===t?dt:ct}function mt(t){return null==t?"—":parseFloat(t).toFixed(1)+"%"}function ut(t){if(null==t)return"—";const e=parseFloat(t);return isNaN(e)?"—":e>=1?e.toFixed(1)+" GiB":(1024*e).toFixed(0)+" MiB"}function _t(t){if(null==t)return"—";const e=parseFloat(t);return isNaN(e)?"—":e>=1?e.toFixed(1)+" MB/s":e>=.001?(1024*e).toFixed(1)+" KB/s":(1024*e*1024).toFixed(0)+" B/s"}class gt extends nt{static properties={label:{type:String},value:{type:String},percent:{type:Number}};static styles=r`
  ...
  `;_colorClass(){const t=this.percent??0;return t>=90?"error":t>=70?"warning":"success"}render(){const t=Math.min(100,Math.max(0,this.percent??0));return B`
    ...
    `}}customElements.define("proxmox-stat-bar",gt);class vt extends nt{static properties={group:{type:Object},mode:{type:String}};static styles=r`
    :host {
      display: block;
    }
    .header {
  ...
  `;_s(t){return this.group?.entities?.[t]?.state?.state??null}render(){const{mode:t,group:e}=this,s=this._s("cpu"),i=this._s("memory_pct"),o=this._s("disk_gb"),r=this._s("disk_max_gb"),n=this._s("uptime_h"),a=parseFloat(s)||0,l=parseFloat(i)||0,c=o&&r?parseFloat(o)/parseFloat(r)*100:0;return B`
      ...
      ${"minimal"!==t?B`
            ...
            ></proxmox-stat-bar>
          `:""}
    `}}customElements.define("proxmox-node-row",vt);class ft extends nt{static properties={hass:{attribute:!1},_config:{state:!0}};static styles=r`
    .editor {
      display: flex;
  ...
  `;setConfig(t){this._config={title:"Proxmox",mode:"normal",show_network:!0,show_storage:!0,sort_vms:"name",...t}}_changed(t,e){this._config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,[t]:e}},bubbles:!0,composed:!0}))}render(){if(!this._config)return B``;const t=this._config;return B`
      <div class="editor">
    ...
    `}}customElements.define("proxmox-card-editor",ft);const $t=["minimal","normal","dense"];class xt extends nt{static properties={hass:{attribute:!1},_config:{state:!0},_mode:{state:!0}};static styles=r`
    :host { display: block; }
  ...
  `;static getStubConfig(){return{title:"Proxmox",mode:"normal"}}static getConfigElement(){return document.createElement("proxmox-card-editor")}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={title:"Proxmox",mode:"normal",exclude:[],show_network:!0,show_storage:!0,sort_vms:"name",...t},$t.includes(this._config.mode)||(this._config.mode="normal"),this._mode=null}get _activeMode(){return this._mode??this._config?.mode??"normal"}_switchMode(t){this._mode=t}_sortVms(t){const e=this._config?.sort_vms??"name";return"name"===e?t:[...t].sort((t,s)=>{const i=(t,e)=>parseFloat(t.entities?.[e]?.state?.state)||0,o={cpu:"cpu",ram:"memory_pct",disk:"disk_gb"};return i(s,o[e]??"cpu")-i(t,o[e]??"cpu")})}render(){if(!this.hass||!this._config)return B``;const{nodes:t,vms:e,storages:s}=function(t,e){if(!t?.entities)return{nodes:[],vms:[],storages:[]};const s=new Set(e?.exclude??[]),i=new Map;for(const[e,o]of Object.entries(t.entities))"proxmoxve"===o.platform&&(s.has(e)||o.device_id&&(i.has(o.device_id)||i.set(o.device_id,[]),i.get(o.device_id).push({entity_id:e,translation_key:o.translation_key})));const o=[],r=[],n=[];for(const[e,s]of i){const i=t.devices?.[e],a=ht[i?.model];if(!a)continue;const l=i?.name_by_user||i?.name||e,c=pt(a),d={};for(const{entity_id:e,translation_key:i}of s){const s=c[i];if(!s||s in d)continue;const o=t.states?.[e]??null;d[s]={entity_id:e,state:o}}const h=i?.via_device_id;if("storage"===a){const t=l.replace(/^Storage \(/,"").replace(/\)$/,"");n.push({type:"storage",name:t,device_id:e,node_device_id:h,entities:d})}else"node"===a?o.push({type:a,name:l,device_id:e,node_device_id:h,entities:d}):r.push({type:a,name:l,device_id:e,node_device_id:h,entities:d})}return o.sort((t,e)=>t.name.localeCompare(e.name)),r.sort((t,e)=>t.name.localeCompare(e.name)),n.sort((t,e)=>t.name.localeCompare(e.name)),{nodes:o,vms:r,storages:n}}(this.hass,this._config),i=this._sortVms(e),o=this._activeMode;return B`
    ...
    `}_renderVmRow(t,e){const s="minimal"===e,i="dense"===e,o=e=>t.entities?.[e]?.state?.state??null,r="on"===o("running");return B`
      <div class="vm-row ${i?"dense":""}">
        <div class="vr-dot ${r?"on":"off"}"></div>
        <span class="vr-name">${t.name}</span>
        ${s?"":B`<span class="vr-badge">${"vm"===t.type?"VM":"CT"}</span>`}
        ${s?"":B`
          <div class="vr-stats">
            <span class="vr-stat">${mt(o("cpu"))}</span>
            <span class="vr-stat">${mt(o("memory_pct"))}</span>
            <span class="vr-stat-wide">${ut(o("disk_gb"))}</span>
          </div>
        `}
      </div>
    `}_renderVmSection(t,e){if(!t.length)return B``;return B`
    ...
    `}_renderNetworkSection(t,e){if("minimal"===e)return B``;const s=t.filter(t=>t.entities.net_in_mbs||t.entities.net_out_mbs);return s.length?B`
      ...
      <div class="net-section">
        ...
        ${s.map(t=>{const e=t.entities.net_in_mbs?.state?.state,s=t.entities.net_out_mbs?.state?.state;return B`
            <div class="net-row">
              ...
              <span class="net-val">${_t(s)}</span>
              <span class="net-val">${_t(e)}</span>
            </div>
          `})}
      </div>
    `:B``}_renderStorageSection(t,e){return"minimal"!==e&&t.length?B`
      ...
      <div class="storage-section">
        ${t.map(t=>{const e=t.entities.used_gb?.state?.state,s=parseFloat(t.entities.used_pct?.state?.state)||0;return B`
            <div class="storage-item">
              ...
              <proxmox-stat-bar .label=${" "} .value=${ut(e)} .percent=${s}></proxmox-stat-bar>
            </div>
          `})}
      </div>
    `:B``}getCardSize(){return 3}}customElements.define("proxmox-card",xt),window.customCards=window.customCards||[],window.customCards.push({type:"proxmox-card",name:"Proxmox Card",description:"Monitor Proxmox VE nodes, VMs, and containers",preview:!1,documentationURL:"https://github.com/flejz/hass-proxmox-widget"});
